...
describe("Musician Service", () => {
  ...
  describe("getMusicianId", () => {
    it("should get existing musician ID successfully", async () => {
      ...
      // 2. verify findByIdAndUpdate was called
    ...
    it("should handle findByIdAndUpdate failure", async () => {
      ...
      // ==================== Act & Assert ====================
      await expect(getMusicianId(params)).rejects.toThrow("Musician not found");
    ...
    it("should handle findOne database error", async () => {
      ...
      mockMusicianModel.findOne.mockRejectedValue(new Error("Database connection error"));

      // ==================== Act & Assert ====================
      await expect(getMusicianId(params)).rejects.toThrow("Database connection error");
